...
.. note:: Установка или обновление могут быть произведены сотрудниками NextGIS при наличии удаленного доступа, `подробнее о том, что именно понадобится <https://docs.nextgis.ru/docs_ngweb/source/remote.html>`_.
